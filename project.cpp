...
//tkt_pr is to print the no.of tickets to be booked1
...
//2nd arg is for the particular movie time
{
    ...
    char ch='A',st;
    system("clear");
    cout<<"\n\nCOST OF RECTILINER:Rs 500/-\n";
      cout<<"COST OF GOLD :Rs 200/-\n";
    cout<<"COST OF  SILVER :Rs 100/-\n";
ifstream fin;//this part is for retrieving moive name from file
fin.open("movie_test2.csv");
